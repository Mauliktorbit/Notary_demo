                ...
                <div className='col-md-6 login-form'>
                    <div className='container-fluid col-7'>
                        ...
                        <div className="d-flex justify-content-center mt-5">
                            <Link to={'/notarytype'} className="btn btn-cancel me-3 small-long" style={{ width: '80%' }}>Sign in</Link>
                        </div>
                        <div className='sinup mt-3'>
                            <p>Don't have an account? <Link to={'/IndividualUserSignUp'}><b>Sign Up</b></Link></p>
                        </div>
                    </div>
                </div>
            </div>
