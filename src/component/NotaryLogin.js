  ...
  return (
    <div>
      <div className="main-com">
        <div
          className="col-md-6 login-img"
          style={{ background: 'burlywood' }}
        >
          <img
            src="assets/img/login5.png"
            alt="Login"
          ...
          <div className="container-fluid col-7">
              ...
              <div className="col-12">
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="Enter Public Number"
                    required
                  />
                </div>
              </div>
            ...
            <div className="sinup mt-3">
              <p>
                ...
                <Link to={'/notarysignup'}><b>Sign Up</b></Link>
              </p>
            </div>
          </div>
        </div>
